...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.javac");
        gc.setOutputDir("E:/bz/yebhd/yeb-generator/src/main/java");
        //作者
        gc.setAuthor("suzhenqi");
        //打开输出目录
        gc.setOpen(false);
        //xml开启BaseResultMap
...
//        String templatePath = "/templates/mapper.xml.vm";
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return "E:/bz/yebhd/yeb-generator/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
